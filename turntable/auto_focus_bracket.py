...
def main():
    ...
    parser.add_argument('--wide_steps', type=int, default=79)
    parser.add_argument('--med_steps', type=int, default=39)
    parser.add_argument('--narrow_steps', type=int, default=19)
    parser.add_argument('--reset_steps', type=int, default=25)
    ...
    start_position = 0
    num_wide_steps = args.wide_steps
    num_med_steps = args.med_steps
    num_narrow_steps = args.narrow_steps
    num_reset_steps = args.reset_steps
